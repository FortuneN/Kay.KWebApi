...
namespace Kay.KWebApi
{
	internal static class KHelper
	{
		...
		public static string GetMimeType(string pathOrExtenstion)
		{
			...
			{
				pathOrExtenstion = string.Empty;
			}

			if (pathOrExtenstion.Contains("."))
			{
				pathOrExtenstion = pathOrExtenstion.Split('.').LastOrDefault() ?? string.Empty;
			}
			
			switch (pathOrExtenstion?.ToLower())
			{
